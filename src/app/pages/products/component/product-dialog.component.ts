...
@Component({
  ...
  template: `
    <div
      class="p-2 bg-surface-overlay rounded-xl shadow-md h-[750px]
     "
    >
      <div class="flex-1 overflow-auto p-2 h-full">
        ...
        <form [formGroup]="form" class="p-fluid" (ngSubmit)="save()">
          <div class="flex flex-col gap-6">
            ...
            <div class="field">
              <label for="reference" class="block mb-3">{{
                'product.reference' | translate
              }}</label>
            ...
            <div class="flex justify-between gap-4">
              <div class="field">
                <label for="quantity" class="block mb-3">{{
