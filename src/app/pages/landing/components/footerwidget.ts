    ...
    <div class="py-12 px-12 mx-0 mt-20 lg:mx-20">
      <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 md:col-span-2">
          ...
          >
            <img src="assets/img/logo.png" alt="logo" class="w-10 h-10 mr-2" />
            <h4 class="font-medium text-3xl text-surface-900 dark:text-surface-0 text-nowrap">
              {{ ConfigConstant.APPLICATION_NAME }}
            </h4>
          </a>
        </div>
          ...
          <div class="grid grid-cols-12 gap-8 text-center md:text-left">
            ...
            <div class="col-span-12 md:col-span-3">
              ...
              <a
                ...
                >Events<img src="/assets/img/logo.png" alt="badge" class="ml-2"
              /></a>
              <a
                class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100"
                >FAQ</a
